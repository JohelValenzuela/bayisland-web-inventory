...
foreach($fila = $medidas as $medidas){
    $pdf->Cell(45, 8, iconv('UTF-8', 'windows-1252', $medidas->id), 1, 0, 'C', 0);
    $pdf->Cell(115, 8, iconv('UTF-8', 'windows-1252', $medidas->nombre), 1, 0, 'C', 0);  
    $pdf->Cell(30, 8, iconv('UTF-8', 'windows-1252', $medidas->estado), 1, 1, 'C', 0);  
}


$pdf->Output('ReporteMedidas.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
$pdf->Output();