<fieldset class="fielset">
    ...
    <?php  for ($i = 1; $i <= $maxGuias; $i++) { // Itera para generar los campos de guía ?>  
        <div class="div-flex" id="guia_<?php echo $i; ?>" style="<?php echo $i === 1 ? '' : 'display: none;'; ?>">
            <div class="campo campo-separado">
                <label for="guia<?php echo $i; ?>_id">Guía <?php echo $i; ?>:</label>
                <select class="buscar" name="guia<?php echo $i; ?>_id" id="guia<?php echo $i; ?>_id">
    ...
    <?php } ?>
    <button type="button" id="mostrar_siguiente_guia" class="boton-exportar formulario">Agregar Campo</button>
</fieldset>
...
<fieldset class="fielset"> 
    ...
    <div class="div-flex">
        <div class="campo campo-separado w-40">
            ...
            <select class="buscar" name="guia_muelle" id="guia_muelle">
...
<fieldset class="fielset"> 
    ...
    <div class="div-flex">
        <div class="campo campo-separado w-50">
            ...
            <select class="buscar" name="reportado_por_id" id="reportado_por_id">
...
<fieldset class="fielset"> 
    ...
    <div class="campo campo-separado w-50"">
        ...
        <select class="buscar" name="guias_bote_ids[]" id="guias_bote_ids" multiple="multiple">
            <?php foreach ($guias as $guia) : ?>
                <option value="<?php echo $guia->id; ?>"><?php echo $guia->nombre; ?></option>
            <?php endforeach; ?>
        </select>
...
<fieldset class="fielset"> 
    ...
    <div class="div-flex">
        <div class="campo campo-separado w-50">
            ...
            <select class="buscar" name="capitan_id" id="capitan_id">
